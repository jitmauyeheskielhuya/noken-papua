...
class AuthController extends Controller
{
    ...
    public function attemptLogin()
    {
        ...
        //rolennya salah?
        if (!in_array($role, $this->auth->user()->getRoles())) {
            $this->auth->logout();
            return redirect()->back()->withInput()->with('error', 'anda tidak punya hak akses sebagai ' . $role);
        }
    ...
    public function attemptRegister()
    {
        // Check if registration is allowed
        if (!$this->config->allowRegistration) {
            return redirect()->back('/akun')->withInput()->with('error', lang('Auth.registerDisabled'));
        }
