        ...
        <div class="col-6 mx-60 ml-10 bg-slate-200 p-3 rounded-md pr-5">
          <form action="<?= base_url('admin/save_subkriteria'); ?>" method="post">
            ...
            <div class="mb-4">
              ...
              <input type="text" name="nama_subkriteria" class="w-full border-gray-300 focus:border-indigo-500 rounded-md shadow-md py-2 px-2" required placeholder="Masukan Nama Subkriteria" autofocus>
            </div>

            <div class="mb-4">
              <label class="block text-emerald-400 font-medium text-base mb-2">Nilai Subkriteria</label>
              <input type="text" name="nilai_subkriteria" class="w-full border-gray-300 focus:border-indigo-500 rounded-md shadow-md py-2 px-2" required placeholder="Masukan Nilai Subkriteria" autofocus>
            </div>
