...
<script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-xYaTXvSsCHIDFme4"></script>
</head>
...
<body>
  ...
  <section id=" home" class="pt-20 pb-16 bg-slate-100 dark:bg-slate-800">
        ...
        <div class="container mx-auto py-8 bg-slate-200 rounded-md shadow-md mb-16">
          <?php foreach ($kriteria as $k) : ?>
            <div class="w-64 mx-auto mt-8">
              <label class="block mb-2 font-bold text-emerald-400" for="kriterian"> <?= $k['nama_kriteria'] ?></label>
    ...
    <div class="container">
      <div class="w-full px-4">
        <div class="max-w-xl mx-auto text-center mb-16">
          <h2 class="font-bold text-emerald-400 text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-emerald-400">Rekomendasi Produk E-Comerce Noken Papua</h2>
