    ...
    <div class="row">
      <div class="bg-slate-100 col-5 p-4 rounded-md shadow-md">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="harga_noken" class="border border-gray-300 px-4 py-2 w-full rounded-md shadow-md">
        </div>
        <div class="mb-4">
          <label for="ukuran" class="block font-medium mb-2 text-emerald-400">Ukuran Noken</label>
          <input type="text" name="ukuran_noken" class="border border-gray-300 px-4 py-2 w-full rounded-md shadow-md">
        </div>
        <div class="mb-4">
          <label for="motif" class="block font-medium mb-2 text-emerald-400">Motif Noken</label>
          <input type="text" name="motif_noken" class="border border-gray-300 px-4 py-2 w-full rounded-md shadow-md">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="lokasi_penjualan" class="border border-gray-300 px-4 py-2 w-full rounded-md shadow-md">
        </div>
        <div class="mb-4">
          <label for="gambar" class="block font-medium mb-2 text-emerald-400">Gambar Noken</label>
          <input type="file" name="gambar_noken" class="border border-gray-300 px-4 py-2 w-full rounded-md shadow-md">
        </div>
        <div class="mb-4">
          <label for="tgl_daftar" class="block font-medium mb-2 text-emerald-400">Tanggal Daftar</label>
          <input type="date" name="tgl_daftar" class="border border-gray-300 px-4 py-2 w-full rounded-md shadow-md">
        </div>
